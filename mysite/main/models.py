...
class MainProduktai(models.Model):
    ...
    id_country_name_url_to_product_categorypath_url_to_image_curren = models.CharField(db_column='ID;Country;Name;URL to product;categoryPath;URL to image;Curren', max_length=1024, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
